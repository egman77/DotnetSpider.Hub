...
namespace DotnetSpider.Enterprise.EntityFrameworkCore
{
	public class ApplicationDbContext : IdentityDbContext<ApplicationUser, IdentityRole<long>, long>
	{
		...
		public DbSet<BuildLog> Build_Logs { get; set; }
		public DbSet<BuildStatus> Build_Statuses { get; set; }
		public DbSet<BuildHistory> Build_Histories { get; set; }
		public DbSet<ExecuteLog> Execute_Logs { get; set; }
		public DbSet<TaskBatch> Task_Batches { get; set; }
	...
	public class ToDoContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
	{
		public ApplicationDbContext CreateDbContext(string[] args)
		{
			...
			builder.UseSqlServer("Server=.\\SQLEXPRESS;Integrated Security = SSPI;");
